...
#search_exclude: true  # could enable this too, if we wanted? ~peyrin Nov 2025
---
...
In the form, there should be a box at the end of the form, asking if you have any special requests. In this box, indicate that you'll be proctored externally by athletics staff, and **include the email and phone number of your proctor**. As long as you fill out the box at the end, you can fill out the rest of the form with dummy values; it doesn't matter.
...
- A printed copy of a reference sheet: <https://assets.cs168.io/cs168-reference-card.pdf>
- Double-sided, handwritten cheat sheet(s): 2 for the midterm, 3 for the final exam. The cheat sheets can be handwritten, or handwritten on a tablet and printed, or typed.
...
- At the official exam start time, you will receive an email from cs168@berkeley.edu, with a PDF of the exam and a PDF of the reference card.
...
- Email the scanned exam and the signed integrity agreement to cs168@berkeley.edu. This should be done within 12 hours of the student finishing the exam (ideally, immediately afterwards).
